...
BORDER_WIDTH="3" NORMAL_BC="#14171C" FOCUSED_BC="#5F5569"

# Fade true|false	# Shadows true|false	# Corner radius		# Shadow color			# Animations true|false
P_FADE="true" P_SHADOWS="true" P_CORNER_R="2" SHADOW_C="#000000" ANIMATIONS="true"
...
set_bspwm_config() {
  ...
  bspc config urgent_border_color "${redb}"
...
set_bspwm_rules() {
  bspc rule -a *:*:'Planify - Quick Add' follow=on state=floating
  bspc rule -a *:*:'QEMU' follow=on state=floating
}
